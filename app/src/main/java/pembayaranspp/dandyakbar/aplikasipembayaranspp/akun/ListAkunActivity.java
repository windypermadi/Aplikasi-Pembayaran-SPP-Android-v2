package pembayaranspp.dandyakbar.aplikasipembayaranspp.akun;
...
import pembayaranspp.dandyakbar.aplikasipembayaranspp.auth.ProfilActivity;
...
import pembayaranspp.dandyakbar.aplikasipembayaranspp.model.AkunModel;
...
public class ListAkunActivity extends AppCompatActivity {
    ...
    List<pembayaranspp.dandyakbar.aplikasipembayaranspp.model.AkunModel> AkunModel;
    ...
    public class PegawaiAdapter extends RecyclerView.Adapter<PegawaiAdapter.ProductViewHolder> {
        ...
        public void onBindViewHolder(ProductViewHolder holder, int i) {
            ...
            holder.cv.setOnClickListener(v -> {
                ...
                x.putExtra("idsiswa", kelas.getIdforeign());
