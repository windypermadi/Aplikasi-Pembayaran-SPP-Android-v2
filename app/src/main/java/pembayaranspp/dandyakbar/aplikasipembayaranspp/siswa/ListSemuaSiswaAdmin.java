package pembayaranspp.dandyakbar.aplikasipembayaranspp.siswa;
...
import pembayaranspp.dandyakbar.aplikasipembayaranspp.auth.BioSiswaActivity;
...
import pembayaranspp.dandyakbar.aplikasipembayaranspp.model.SiswaModel;
...
public class ListSemuaSiswaAdmin extends AppCompatActivity {
    ...
    List<pembayaranspp.dandyakbar.aplikasipembayaranspp.model.SiswaModel> SiswaModel;
    ...
    private void ActiomButton() {
        ...
        findViewById(R.id.add).setOnClickListener(v -> {
            startActivity(new Intent(ListSemuaSiswaAdmin.this, TambahSiswaNew.class));
        });
    }
